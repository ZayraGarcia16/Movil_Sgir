...
const ReservationForm = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const destinationsRes = await fetch("http://192.168.0.16:9700/api/destinos");
        ...
        const hotelsRes = await fetch("http://192.168.0.16:9700/api/hotels");
        const hotelsData = await hotelsRes.json();
        setHotels(hotelsData);

        // Comidas: ya vienen con precio
        const comidaRes = await fetch("http://192.168.0.16:9700/api/comida");
  ...
  const handleReserve = () => {
    ...
    fetch("http://192.168.0.16:9700/api/reservas", {
      method: "POST",
      headers: {

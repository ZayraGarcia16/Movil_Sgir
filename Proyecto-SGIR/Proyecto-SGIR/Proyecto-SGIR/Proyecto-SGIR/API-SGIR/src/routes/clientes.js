 ...
 */
router.delete("/clientes/:id", verifyToken, verifyRole(['Administrador']), borrarcliente);
 ...
 */
router.get('/clientes/registro', verifyToken, verifyRole(['Administrador']), (req, res) => {
  res.json({ message: "lista de asistencias (solo para administradores)" });
});

        ...
        <div className="dashboard-container">
            ...
            <aside className="sidebar">
                <ul className="menu">
                    ...
                    <li><Link to="/paquete"><FaBoxOpen /> Paquetes</Link></li>
                    <li><Link to="/excursiones"><FaHiking /> Excursiones</Link></li>
                    <li><Link to="/comentario"><FaComments /> Comentarios</Link></li>
                    <li><Link to="/crudcontacto"><FaEnvelope /> Contacto</Link></li>
                    <li><Link to="/hotel"><FaHome /> Hoteles</Link></li>
